...
export const getMyFriendsDto = async (email) => {
    ...
    friendsWithLastMessage.sort((a, b) => b.lastMessage.createdAt - a.lastMessage.createdAt);

    return Response.success('Friends fetched successfully',friendsWithLastMessage);
};
